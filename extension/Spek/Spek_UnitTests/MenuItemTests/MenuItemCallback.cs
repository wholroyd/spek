...
using ElectricSky.Spek;

namespace Spek_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new SpekPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(ElectricSky.Spek.GuidList.guidSpekCmdSet, (int)ElectricSky.Spek.PkgCmdIDList.cmdidMyCommand);
