...
namespace Spek_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(ElectricSky.Spek.GuidList.guidSpekCmdSet, (int)ElectricSky.Spek.PkgCmdIDList.cmdidMyCommand);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "Spek", "ElectricSky.Spek.SpekPackage");
